...
\name{Semih}{Balki}
\position{Cryptography{\enskip\cdotp\enskip}Algorithms{\enskip\cdotp\enskip}Data Science}
% \address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+90) 532-571-41-09}
\email{semihbalki@sabanciuniv.edu}
%\homepage{michaelpollind.com}
\github{smhblk04}
\linkedin{Semih Balki}
% \gitlab{gitlab-id}
